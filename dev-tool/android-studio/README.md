...
10~30分钟：gradle的极简介绍及build.gradle解析——魔法的核心
----------------
gradle是一个Android Studio默认的项目构建工具。Eclipse是使用的Ant作为构建工具。gradle是时代发展的产物，他和Ant比起来，配置极为简单（其实我没配过Eclipse的Android项目^_^）、功能也更加强大。至于到底多强大，下面我举一个场景，大家感受一下：  
...
对于Ant，这太难了。而对于gradle来说，添加几行代码就能做到。  
...
如果想了解更多关于gradle在Android中的使用，可以看Google官方给出的[指导文档](http://tools.android.com/tech-docs/new-build-system/user-guide)。